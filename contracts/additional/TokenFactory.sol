...
/**
 * @title TokenFactory
 * @notice This contract is used to create new token roots.
 */
contract TokenFactory is ITokenFactory {
     ...
     *        This contract can be updated without redeploying it.
     * @param platformCode Code of the TokenWalletPlatform.sol contract.
    */
    constructor(
        address owner,
        uint128 deployValue,
    ...
    /**
     * @dev Builds a `StateInit` for the TokenRoot upgradeable contract.
     *
     * @param nonce - nonce of the token
     * @param name - name of the token
     * @param symbol - symbol of the token
     ...
     * @param owner - owner of the token
     *
     * @return `StateInit` for the TokenRoot upgradeable contract.
     */
    ...
    /**
     * @notice Changes the value to be sent to the root contract when deploying
     * a new token root.
    ...
    /**
     * @notice Changes the code of the TokenWallet contract, which is used
    ...
    /**
     * @notice Changes the code of the TokenRootUpgradeable contract, which
    ...
    /**
     * @notice Changes the code of the TokenWalletUpgradeable contract,
    ...
    /**
     * @notice Changes the code of the TokenWalletPlatform contract, which
     * is used to deploy new token roots.
     *
     * @param platformCode New code of the TokenWalletPlatform.sol contract.
     *
     * Precondition:
     *  - Should be called only by the owner.
     *
    ...
    /**
     * @notice Changes the owner of the factory.
     *
    ...
    /**
     * @notice Accepts the ownership of the factory.
     *
     * It's two-step process: first, the new pending owner is set,
     * then the pending owner can accept the ownership.
     *
    ...
    /**
     * @notice Upgrades the factory code to a new version.
     *
