...
interface ITokenRoot is TIP3TokenRoot, SID {
    ...
    /**
     * @notice Returns current owner address of TokenRoot.
    ...
    */
    ...
    /**
     * @notice Accepts burning `amount` of tokens from the TokenWallet,
    ...
    /**
     * @notice Mint tokens to a specified recipient, optionally deploying
    ...
    */
    ...
    /**
     * @notice Deploy a new TokenWallet with initial balance.
     *
